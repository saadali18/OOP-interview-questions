...
// 1. Abstraction: The process of hiding the unnecessary details of an object and only exposing the essential information. It can be acheived using Abstract classes or Interface.
...
//extends the abstract class(Must , otherwise the abtract class object cannot be instantiate)
...
public class Car implements CarStart, CarStop //Multiple Inheritance 
{    
public void start()  
{  
...
// .) Overloading: It is also known as static polymorphism or compile time polymorphism in which Functions can be overloaded by changes in the number of arguments or a change in the type of arguments.
